...
class Edit extends Component
{
    ...
    public function mount(MembershipPackage $membershipPackage)
    {
        ...
        $this->membership_type   = $this->membershipPackage->membershipType()->pluck('id')->toArray();
        $this->card_type         = $this->membershipPackage->cardType()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.membership-package.edit');
    }
